...
@array_function_dispatch(_fix_dispatcher, check_signature=False)
...
@array_function_dispatch(_isposinf_dispatcher, check_signature=False)
@_deprecate_out_named_y
...
@array_function_dispatch(_isneginf_dispatcher, check_signature=False)
@_deprecate_out_named_y
